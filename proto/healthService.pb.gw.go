...
func RegisterHealthHandlerServer(ctx context.Context, mux *runtime.ServeMux, server HealthServer) error {
	...
	mux.Handle("GET", pattern_Health_HealthCheck_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Health_HealthCheck_0(rctx, inboundMarshaler, server, req, pathParams)
...
var (
	pattern_Health_HealthCheck_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"_ah", "health"}, "", runtime.AssumeColonVerbOpt(true)))
)
